...
import Logo from '../assets/images/D-hikers.png'
      ...
      <header className="bg-white shadow-sm w-full sticky top-0 z-40">
        ...
        <div className="container hidden lg:flex items-center justify-between py-3">
          <NavLink to="/" className="flex items-center gap-3 text-xl font-semibold text-slate-900">
             <img className='w-20 h-20 object-cover' src={Logo} alt="Dhauladhar Hikers" />
          </NavLink>
        ...
        <div className="container lg:hidden flex items-center justify-between py-4 relative">
          ...
          <NavLink to="/" className="flex items-center gap-1 text-xl font-semibold text-slate-900">
            <img className='w-16 h-16 object-cover' src={Logo} alt="Dhauladhar Hikers" />
          </NavLink>

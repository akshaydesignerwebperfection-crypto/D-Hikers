        ...
        <div className="container">
          <div className="flex items-center justify-between ">
            <div className="flex items-center gap-6">
              ...
              <Link to="mailto:dhauladharhikers72@gmail.com" className="text-sm text-gray-300 font-normal flex items-center gap-2">
            ...
            <div className="flex items-center gap-4">
              <Link className="text-sm text-gray-300 hover:text-white" to="#" title="Twitter">𝕏</Link>
              <Link className="text-sm text-gray-300 hover:text-white" to="#" title="Facebook">f</Link>
              <Link className="text-sm text-gray-300 hover:text-white" to="#" title="Instagram">◎</Link>
              <Link className="text-sm text-gray-300 hover:text-white" to="#" title="Pinterest">𝒫</Link>

...
export default function MoroccoTourDetail(){
 ...
 return(
  <>
    ...
    <div className="container">
        <div className="py-16" >
        <h2 className="text-4xl text-white font-bold">Morocco</h2>
        </div>
        <div className="flex justify-end">
            ...
            <li className="text-md font-bold text-[#e8604c] relative before:absolute before:content-['/'] before:top-0 before:left-[-10px] before:text-[#ccc] ">Morocco</li>
        </ol>
        </div>
    </div>
    </section>
